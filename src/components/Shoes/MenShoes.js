      ...
      <div className="shoes__pageMI">
        <div className="shoes__slider">
          ...
          <div className="shoes__slider__1">
            <h2>
              Men Shoes<span style={{ color: "#afafaf" }}> - 500 items</span>
            </h2>
            <hr />
            <h5>Categories</h5>
            <p>Running</p>
                ...
                <div>
                  <p
                    style={{
                      borderRadius: "50px",
                      width: "30px",
                      backgroundImage: `linear-gradient(to right, rgba(255, 91, 90, 1), rgba(168, 255, 192, 1))`,
            ...
            <div>
              ...
              <div className="price__button">
                <input type="checkbox" name="optiona" id="opta" />
                <span style={{ paddingLeft: "30px", color: "#afafaf" }}>1</span>
              </div>
              <div className="price__button">
                <input type="checkbox" name="optiona" id="opta" />
                <span style={{ paddingLeft: "30px", color: "#afafaf" }}>
              ...
              <div className="price__button">
                <input type="checkbox" name="optiona" id="opta" />
                <span style={{ paddingLeft: "30px", color: "#afafaf" }}>2</span>
              </div>
            </div>
            <hr />
            <div>
              ...
              <div className="yellow__shoes">
                <div className="yellow__shoes__0">
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        style={{ borderRadius: "15px", padding: "50px" }}
                        alt="example"
                        src={yellowShoes}
                      />
                    }
                  >
                    ...
                    />
                    <Meta
                      style={{ marginBottom: "8px", fontSize: "25px" }}
                      title={
